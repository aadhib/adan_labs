...
const sections: LegalSection[] = [
  {
    ...
    body: (
      <p>
        ...
        website. They are widely used to make websites work, to make them more
        efficient, and to provide information to site owners. This policy also
        covers similar technologies such as <Term>local storage</Term>, which
        stores data in your browser in a comparable way.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <LegalList
        items={[
          <>
            <Term>adan-cookie-consent</Term> — strictly necessary — stores your
            cookie consent choice so the banner is not shown again — local
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          When you first visit the site, a banner lets you <Term>accept</Term>{" "}
          or <Term>reject</Term> non-essential cookies. Strictly necessary
          technologies are used regardless, as the site cannot function without
          them.
        </p>
        <p>
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        such as an analytics provider. Any such third-party cookies are only set
        with your consent and are governed by the privacy and cookie policies of
        the relevant provider. Current third-party cookies, if any, are listed
        in section 03 above.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        we use or in applicable law. The &ldquo;Last updated&rdquo; date above
