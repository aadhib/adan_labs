...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection id="controller" number="01" title="Who We Are — Data Controller">
        <p>
      ...
      <LegalSection id="data" number="02" title="Personal Data We Collect">
      ...
      <LegalSection id="use" number="03" title="How We Use Your Data & Legal Basis">
        <p>
        ...
        <LegalList
          items={[
            ...
            <>
              ...
              insights; only where you have opted in (consent). You may
      ...
      <LegalSection id="cookies" number="04" title="Cookies & Similar Technologies">
        <p>
          We use cookies and similar technologies to operate the site and,
          subject to your consent, to measure how it is used. Full detail of
          each cookie, its purpose, and how to manage your choices is set out
          in our{" "}
          <Link
            href="/cookies"
            className="font-semibold text-accent underline underline-offset-4 hover:text-foreground"
      ...
      <LegalSection id="sharing" number="05" title="Sharing Your Data">
      ...
      <LegalSection id="transfers" number="06" title="International Data Transfers">
        <p>
          ...
          European Commission adequacy decision or on Standard Contractual
          Clauses approved by the European Commission, together with
          supplementary safeguards where required. You may request a copy of
          the relevant safeguards by contacting{" "}
          <a
            href="mailto:privacy@adanlabs.ai"
            className="font-semibold text-accent underline underline-offset-4 hover:text-foreground"
          >
      ...
      <LegalSection id="security" number="08" title="How We Protect Your Data">
        <p>
          We implement appropriate technical and organisational measures to
          protect personal data against unauthorised access, loss, or
          disclosure — including encryption in transit (TLS), access controls,
          and ongoing review of our processors. No method of transmission over
          the internet is completely secure, and we cannot guarantee absolute
          security.
        </p>
      </LegalSection>

      <LegalSection id="rights" number="09" title="Your Rights Under the GDPR">
        <p>
      ...
      <LegalSection id="authority" number="10" title="Supervisory Authority">
        <p>
      ...
      <LegalSection id="children" number="11" title="Children&rsquo;s Privacy">
        <p>
          This website is intended for business audiences and is not directed
          at children. The digital age of consent in Ireland is 16. We do not
      ...
      <LegalSection id="changes" number="12" title="Changes to This Policy">
        <p>
          ...
          revision. Where changes are material, we will take reasonable steps
          to notify you.
        </p>
      </LegalSection>
